...
class EmployeeFilter(django_filters.FilterSet):
    designation = django_filters.CharFilter(field_name='designation', lookup_expr='iexact') # exact for exact match, iexact for case-insensitive match , icontains for case-insensitive contains
